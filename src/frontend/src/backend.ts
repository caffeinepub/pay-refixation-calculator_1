...
export class Backend implements backendInterface {
    ...
    async listRecords(): Promise<Array<PayFixationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.listRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveRecord(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string, arg7: string, arg8: bigint, arg9: bigint, arg10: bigint, arg11: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveRecord(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
